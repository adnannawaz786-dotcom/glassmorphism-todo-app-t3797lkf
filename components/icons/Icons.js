/* EXPORTS: AddIcon, DeleteIcon, EditIcon, CompleteIcon, IncompleteIcon */
...
export const CompleteIcon = ({ size = 24, className = "" }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const IncompleteIcon = ({ size = 24, className = "" }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
